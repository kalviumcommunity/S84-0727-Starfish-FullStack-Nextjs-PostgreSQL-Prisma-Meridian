    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
            ...
            prisma.project.create({
              data: {
                ...
                githubUrl: "https://github.com/"
                  .concat(orgNames[i].toLowerCase().replace(/\s+/g, "-"), "/")
                  .concat(projectName.toLowerCase().replace(/\s+/g, "-")),
              },
            }),
          ];
        case 12:
        ...
        case 13:
          ...
          return [
            4 /*yield*/,
            prisma.billingRecord.createMany({
              data: [
          ...
          return [
            ...
            prisma.insight.create({
              data: {
                ...
                description:
                  'The recent deployment "feat: add background image processing workers" likely caused the 250% increase in AmazonEC2 costs starting on '.concat(
                    spikeDate.toLocaleDateString(),
                    ". Consider optimizing worker counts or using spot instances.",
                  ),
